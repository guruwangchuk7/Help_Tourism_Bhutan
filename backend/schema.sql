...
(1, 'Punakha Dzong', '/punakha-dzong.jpg', 'Punakha Dzong, also known as Pungtang Dechen Phodrang (''Palace of Great Happiness''), is the second oldest and most majestic dzong in Bhutan. Built in 1637 at the scenic confluence of the Pho Chhu and Mo Chhu rivers, it serves as the winter home of the central clergy. It houses sacred relics and serves as a vital historical monument, famous for its intricate woodwork and defensive design. In spring, blooming lilac jacaranda trees frame its whitewashed walls, making it one of Bhutan''s most photogenic and spiritual locations.', '$120', 4.8, 'Punakha', '1,200m', '1-2 Days', 'Spring/Fall', 'Dzongkha'),
(2, 'Paro Taktsang', '/paro-taksang.jpg', 'Paro Taktsang, famously known as the Tiger’s Nest, is a sacred Buddhist monastery perched precariously on a cliffside 900 meters above the Paro Valley. Established in 1692 around the cave where Guru Rinpoche is said to have meditated, this iconic landmark offers breathtaking views, ancient murals, and a profound spiritual atmosphere reached via a scenic, rewarding pine-forest hike.', '$150', 4.9, 'Paro', '3,120m', '1 Day (hike)', 'Spring/Fall', 'Dzongkha'),
(3, 'Dochula Pass', '/dochula-pass.jpg', 'Dochula Pass is a breathtaking mountain pass situated at 3,100 meters on the road from Thimphu to Punakha. It is renowned for its panoramic 360-degree views of the snow-capped Himalayan range and the 108 beautiful memorial chortens (shrines) built in honor of fallen soldiers, making it a peaceful, spiritually inspiring stop.', '$95', 4.7, 'Thimphu', '3,100m', 'Half Day', 'Spring/Fall', 'Dzongkha'),
(4, 'Thimphu Valley', '/thimphu.jpg', 'Thimphu Valley houses the unique capital of Bhutan, blending modern expansion with deep-rooted cultural values. Surrounded by green hills, it features the grand Tashichho Dzong, the massive Buddha Dordenma overlooking the valley, and traditional museums, all without a single traffic light in the entire city.', '$110', 4.6, 'Thimphu', '2,330m', '2-3 Days', 'Year-round', 'Dzongkha'),
(5, 'Phobjikha Valley', '/monk.jpg', 'Phobjikha Valley is a stunning, wide glacial valley situated on the slopes of the Black Mountains. Renowned for its natural beauty and peaceful atmosphere, it is famous as the winter nesting ground of the rare, endangered black-necked cranes. The historic Gangtey Monastery overlooks this vast, scenic wetland.', '$130', 4.8, 'Wangdue Phodrang', '3,000m', '2 Days', 'Winter/Spring', 'Dzongkha'),
(6, 'Bumthang Valley', '/airport.jpg', 'Bumthang Valley is the spiritual heartland of Bhutan, consisting of four high-altitude valleys rich in ancient legend, sacred temples, and historic monasteries. As the birthplace of many Buddhist saints and home to Kurjey and Jambay Lhakhang, it offers deep historical walks, local cheese farms, and untouched alpine beauty.', '$140', 4.9, 'Bumthang', '2,600m', '3-4 Days', 'Spring/Fall', 'Dzongkha')
